...
;General
  ...
  ;Name and file
  Name "Bliss"
  OutFile "Bliss-Setup-${app_revision}-${app_branch}.exe"
...
;Interface Settings
  ...
  !define MUI_FINISHPAGE_LINK "Please visit http://blissmedia.net.au/ for more information."
  !define MUI_FINISHPAGE_LINK_LOCATION "http://blissmedia.net.au/"
